...
module.exports.run = async (bot, message, args) => {
    ...
    if (!args[0]) return message.channel.send("Lütfen <!kız isim yaş> Olarak Yazınız!")
    if (!args[1]) return message.channel.send("Lütfen <!kız isim yaş> Olarak Yazınız!")
    ...
    var role2 = member.guild.roles.find("name", "🌸 | Ladies");
